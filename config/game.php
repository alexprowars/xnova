...
return [
	...
	'combat' => [
		...
		// Флот в обломки
		'debrisFactor_FLEET' => env('GAME_FLEET_DEBRIS_RATE', 0.3),
		// Оборона в обломки
		'debrisFactor_DEFENSE' => env('GAME_DEFENSE_DEBRIS_RATE', 0),
		'repairedToDebris' => true,
		'defenseRepairProbability' => 0.7,
		'shipRepairProbability' => 0,
