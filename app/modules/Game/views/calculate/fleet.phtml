...
<style>
	...
	.coord-input { width: 30px !important; text-align: center; margin-left: 0 !important; margin-right: 0 !important; }
	.coord-input-small { width: 20px !important; text-align: center; margin-left: 0; margin-right: 0; }
	...
	#flight-times-panel { padding: 0; }

	#set-save-departure-now span { display: inline; padding: 0; font-weight: lighter;}
				...
				<div id="general-settings">
					<table cellpadding="2" cellspacing="0" border="0" align="center">
						<tr>
							...
							<td><input id="cmb-drive" type="text" name="cmb-drive" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="<?=$user[$this->storage->resource[115]]?>" tabindex="1" /></td>
							<td><label for="imp-drive">Имп. двигатель</label></td>
							<td><input id="imp-drive" type="text" name="imp-drive" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="<?=$user[$this->storage->resource[117]]?>" tabindex="2" /></td>
							<td><label for="hyp-drive">Гипер. двигатель</label></td>
							<td><input id="hyp-drive" type="text" name="hyp-drive" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="<?=$user[$this->storage->resource[118]]?>" tabindex="3" /></td>
							<td></td>
							<td>
							...
							<td valign="top">
								<table cellpadding="0" cellspacing="0" border="0" style="margin-left: 10px;">
									<tr>
										...
										<td>
											<input id="destination-g" type="text" name="destination-g" class="ui-state-default ui-corner-all ui-input coord-input-small ui-input-margin" value="1" alt="Пункт назначения-Галактика" tabindex="23" />:<input id="destination-s" type="text" name="destination-s" class="ui-state-default ui-corner-all ui-input coord-input ui-input-margin" value="1" alt="Пункт назначения-Система" tabindex="24" title="">:<input id="destination-p" type="text" name="destination-p" class="ui-state-default ui-corner-all ui-input coord-input-small ui-input-margin" value="1" alt="Пункт назначения-Планета" tabindex="25" title="">
										</td>
										<td style="width: 30px;">&nbsp;</td>
