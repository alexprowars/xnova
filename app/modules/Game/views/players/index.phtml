			...
			<div class="table">
				<div class="row">
					...
					<div class="col-xs-6">
						...
						<? if ($parse['race'] != 0): ?>
							<br><img src="<?=$this->url->getBaseUri() ?>assets/images/skin/race<?=$parse['race'] ?>.gif" alt="">
						<? endif; ?>
					</div>
					<div class="col-xs-2">
						<img src="<?=$this->url->getBaseUri() ?>assets/images/ranks/m<?=$parse['m'] ?>.png" alt="Промышленная отрасль" title="Промышленная отрасль"><br>
						<img src="<?=$this->url->getBaseUri() ?>assets/images/ranks/f<?=$parse['f'] ?>.png" alt="Военная отрасль" title="Военная отрасль">
					</div>
				</div>
			</div>
			<div class="table">
