<form action="{{ url('alliance/admin/edit/rights/') }}" method="POST">
	<table class="table">
		<tr>
			<td class="c" colspan="13">{{ _text('Configure_laws') }}</td>
		</tr>
		<tr>
...
<form action="{{ url('alliance/admin/edit/rights/add/name/') }}" method="POST">
	<table class="table">
		<tr>
			<td class="c" colspan="2">{{ _text('Range_make') }}</td>
		</tr>
		<tr>
			<th>{{ _text('Range_name') }}</th>
			<th><input type="text" name="newrangname" size=20 maxlength=30 title=""></th>
		</tr>
		<tr>
			<th colspan="2"><input type="submit" value="{{ _text('Make') }}"></th>
		</tr>
	</table>
</form>
<div class="separator"></div>
<table class="table">
	...
	<tr>
		<td class="c" colspan="2"><a href="{{ url('alliance/admin/edit/ally/') }}">{{ _text('Return_to_overview') }}</a></td>
	</tr>
</table>