<table class="table">
	<tr>
		<th colspan="3" style="text-align:center;">Обновлено в <?=$this->game->datezone("H:i:s d.m.Y", $parse['update']) ?></th>
	</tr>
	<? foreach ($parse['Records'] AS $group => $list): ?>
		<tr>
			<td class="c" style="width:199px"><?=$group ?></td>
			<td class="c" style="width:203px">Игрок</td>
			<td class="c" style="width:172px">Уровень</td>
		</tr>
		<? foreach ($list AS $building => $info): ?>
		<tr>
