<div class="table-responsive" id="imperium">
	<table class="table">
		<tr valign="left">
			<td class="c" colspan="{{ parse['mount'] }}">{{ _text('imperium_vision') }}</td>
		</tr>
		<tr>
			<th colspan="2">&nbsp;</th>
			{{ parse['file_images'] }}
		...
		<tr>
			<th colspan="2">{{ _text('name') }}</th>
			{{ parse['file_names'] }}
			<th>&nbsp;</th>
		</tr>
		<tr>
			<th colspan="2">{{ _text('coordinates') }}</th>
			{{ parse['file_coordinates'] }}
			<th>&nbsp;</th>
		</tr>
		<tr>
			<th colspan="2">{{ _text('fields') }}</th>
			{{ parse['file_fields'] }}
			<th>{{ parse['file_fields_c'] }} / {{ parse['file_fields_t'] }}</th>
		</tr>

		<tr>
			<td class="c" colspan="{{ parse['mount'] }}" align="left">{{ _text('resources') }}</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="c" colspan="{{ parse['mount'] }}" align="left">{{ _text('buildings') }}</td>
		</tr>
		{{ parse['building_row'] }}
		<tr>
			<td class="c" colspan="{{ parse['mount'] }}" align="left">{{ _text('ships') }}</td>
		</tr>
		{{ parse['fleet_row'] }}
		<tr>
			<td class="c" colspan="{{ parse['mount'] }}" align="left">{{ _text('defense') }}</td>
		</tr>
		{{ parse['defense_row'] }}
		<tr>
			<td class="c" colspan="{{ parse['mount'] }}" align="left">{{ _text('investigation') }}</td>
		</tr>
