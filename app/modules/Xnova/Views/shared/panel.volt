...
<div class="row topnav">
	...
	<div class="col-md-{{ config.view.get('showPlanetListSelect', 0) == 1 ? '5' : '6' }} col-sm-6 col-xs-12">
		<div class="row">
			<div class="col-xs-4 text-xs-center">
				<span onclick="showWindow('{{ _text('xnova', 'tech', 1) }}', '{{ url('info/1/') }}', 600)" class="tooltip hidden-xs-down" data-content='<table width=150><tr><td width=30%>КПД:</td><td align=right>{{ planet['metal_mp'] }}%</td></tr><tr><td>В час:</td><td align=right>{{ pretty_number(planet['metal_ph']) }}</td></tr><tr><td>День:</td><td align=right>{{ pretty_number(planet['metal_ph'] * 24) }}</td></tr></table>'><span class="sprite skin_metall"></span><br></span>
			...
			<div class="col-xs-4 text-xs-center">
				<span onclick="showWindow('{{ _text('xnova', 'tech', 3) }}', '{{ url('info/3/') }}', 600)" class="tooltip hidden-xs-down" data-content='<table width=150><tr><td width=30%>КПД:</td><td align=right>{{ planet['deuterium_mp'] }}%</td></tr><tr><td>В час:</td><td align=right>{{ pretty_number(planet['deuterium_ph']) }}</td></tr><tr><td>День:</td><td align=right>{{ pretty_number(planet['deuterium_ph'] * 24) }}</td></tr></table>'><span class="sprite skin_deuterium"></span><br></span>
	...
	<div class="col-md-{{ config.view.get('showPlanetListSelect', 0) == 1 ? '5' : '6' }} col-sm-6 col-xs-12">
		<div class="row">
			<div class="col-xs-4 text-xs-center">
				<span onclick="showWindow('{{ _text('xnova', 'tech', 4) }}', '{{ url('info/4/') }}', 600)" title="{{ _text('xnova', 'tech', 4) }}" class="hidden-xs-down"><span class="sprite skin_energie"></span><br></span>
