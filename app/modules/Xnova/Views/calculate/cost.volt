...
<script type="text/javascript" src="{{ url.getBaseUri() }}assets/js/calculate/costs.js"></script>

<link type="text/css" href="{{ url.getBaseUri() }}assets/js/calculate/common.css" rel="stylesheet"/>

<style>
	#costs { margin: auto; width: 100%; }
	.ui-widget-content { margin-bottom: 7px; }
	.level-input { width: 40px !important; text-align: center; margin-left: 2px !important; margin-right: 8px !important; 	border: 1px solid #79B7E7 !important;  color: #1D5987 !important;  font-weight: 700 !important; }
	#technocrat, #engineer, #geologist, #admiral, #arhitector { margin-left: 0; margin-right: 5px;}

	#tab-0, #tab-1, #tab-2 { padding: 0; }
	#tab-0-2, #tab-0-3, #tab-0-4, #tab-0-5, #tab-0-6, #tab-1-2, #tab-1-3, #tab-1-4 { padding: .3em 0; }
	...
	<div class="ui-widget-content ui-corner-all width: auto; ">
		<div>
			<table align="center">
				<tr>
					<td>Уровень М.И.С.</td>
					<td><input id="irn-level" type="text" name="irn-level" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="0" title=""></td>
					<td>Количество планет</td>
					<td>
					<input id="planetsSpin" type="text" class="ui-corner-all input-2columns spin-button" value="8" title="">
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="lab-levels-div">
			<table id="lab-levels-table" class="lined" width="100%;" cellpadding="0" cellspacing="1" border="0">
				<tr>
					...
					<td align="center" width="20%;"><input type="text" id="lablevel_1" name="lablevel_1" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_1" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="even">
					<td align="center">Планета №2</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_2" name="lablevel_2" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_2" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="odd">
					<td align="center">Планета №3</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_3" name="lablevel_3" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_3" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="even">
					<td align="center">Планета №4</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_4" name="lablevel_4" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_4" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="odd">
					<td align="center">Планета №5</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_5" name="lablevel_5" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_5" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="even">
					<td align="center">Планета №6</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_6" name="lablevel_6" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_6" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="odd">
					<td align="center">Планета №7</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_7" name="lablevel_7" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_7" name="start-pln" disabled title=""></td>
				</tr>
								<tr class="even">
					<td align="center">Планета №8</td>
					<td align="center" width="20%;"><input type="text" id="lablevel_8" name="lablevel_8" class="ui-state-default ui-corner-all ui-input input-3columns input-in-table" value="0" title=""></td>
					<td align="center" width="20%;"><input type="radio" id="labchoice_8" name="start-pln" disabled title=""></td>
				</tr>
							</table>
		</div>
		<div class="irn-calc-info">
	...
	<div id="general-settings">
		<table class="table" cellpadding="2" cellspacing="0" border="0" align="center">
			<tr>
				...
				<td>
					<input id="robot-factory-level" type="text" name="robot-factory-level" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="{{ object[registry.resource[14]] }}"/>
				</td>
				<td><label for="nanite-factory-level">Фабрика нанитов</label></td>
				<td>
					<input id="nanite-factory-level" type="text" name="nanite-factory-level" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="{{ object[registry.resource[15]] }}"/>
				</td>
				<td><label for="shipyard-level">Верфь</label></td>
				<td>
					<input id="shipyard-level" type="text" name="shipyard-level" class="ui-state-default ui-corner-all ui-input level-input ui-input-margin" value="{{ object[registry.resource[21]] }}"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td>
								<input id="research-lab-level" type="text" name="research-lab-level" class="ui-state-default ui-corner-all ui-input level-input" value="{{ object[registry.resource[31]] }}"/>
							</td>
							<td>
				...
				<td></td>
				<td>
					<input type="hidden" id="universe-speed" name="universe-speed" value="{{ game.getSpeed('mine') }}">
					<input type="hidden" id="build-speed" name="build-speed" value="{{ game.getSpeed('build') }}">
				</td>
			</tr>
		</table>
	</div>
