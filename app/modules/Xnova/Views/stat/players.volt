<div class="table">
	...
	{% for stat AS $s %}
		<div class="row">
			...
			<div class="th col-sm-1 col-xs-2">
				{% if s['race'] != 0 %}<img src="{{ url.getBaseUri() }}assets/images/skin/race{{ s['race'] }}.gif" width="16" height="16" class="pull-xs-left" style="margin-left:7px;">{% endif %}
				{% if (isset($userId) and $userId != 0 %}{{ s['mes'] }}{% endif %}
			</div>
