...
<form action="{{ url('fleet/stagetwo/') }}" method="post">
	...
	<div class="table">
		<div class="row">
			<div class="c col-12">{{ _text('xnova', 'fl_floten1_ttl') }}</div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_dest') }}</div>
		...
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_speed') }}</div>
			<div class="th col-6">
		...
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_dist') }}</div>
			<div class="th col-6"><div id="distance">-</div></div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_fltime') }}</div>
			<div class="th col-6"><div id="duration">-</div></div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_time_go') }}</div>
			<div class="th col-6"><div id="end_time">-</div></div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_deute_need') }}</div>
			<div class="th col-6"><div id="consumption">-</div></div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_speed_max') }}</div>
			<div class="th col-6"><div id="maxspeed">-</div></div>
		</div>
		<div class="row">
			<div class="th col-6">{{ _text('xnova', 'fl_max_load') }}</div>
			<div class="th col-6"><div id="storage">-</div></div>
		</div>
		<div class="row">
			<div class="c col-12">{{ _text('xnova', 'fl_shortcut') }} <a href="{{ url('fleet/shortcut/') }}">{{ _text('xnova', 'fl_shortlnk') }}</a></div>
		</div>
		{% if parse['shortcut']|length > 0 %}
			<div class="row">
				...
				{% endfor %}
				{% if i%2 == 0 %}<div class="th col-6">&nbsp;</div>{% endif %}
			</div>
		{% endif %}
		{% if parse['planets']|length %}
			<div class="row">
				<div class="c col-12">{{ _text('xnova', 'fl_myplanets') }}</div>
			</div>
			<div class="row">
		...
		{% if parse['aks']|length > 0 %}
			<div class="row">
				<div class="c col-12">{{ _text('xnova', 'fl_grattack') }}</div>
			</div>
