		...
		<select name=\"start\" onChange=\"document.forms[1].submit()\">";
			...
			while ($Log = $Logs->fetch())
			{
				...
				$parse['log'] .= "<tr><td class=\"b\"><center><b>" . $this->game->datezone("H:i:s", $Log['time']) . "</b></center></td>
						...
						<td class=\"b\"><center><a href=?set=players&id=" . $Log['e_id'] . "><img src=/assets/images/s.gif alt=\"Информация об игроке\" title=\"Информация об игроке\" border=0></a></td></center></tr>";
