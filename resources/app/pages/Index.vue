	...
	<div class="page-index">
		<div class="landing-header">
			<Link href="/" class="game-brand" aria-label="XNova">
				<span class="game-brand-mark" aria-hidden="true">X</span>
				<span>NOVA</span>
			</Link>
			...
			<div class="middle">
				<div class="text">
					...
					<div class="landing-features">
						<span>{{ $t('menu.buildings') }}</span>
						<span>{{ $t('menu.fleet') }}</span>
						<span>{{ $t('menu.alliance') }}</span>
					</div>
					<button type="button" id="reg_button" @click="showRegistration">
						{{ $t('interface.start') }}
		...
		<div class="left">
			<div class="middle">
				<div class="loginform">
					...
					<div class="lost-pass">
						<button type="button" @click="showRemindPassword" :title="$t('pages.index.remind_password_title')">
							{{ $t('pages.index.forgot_password') }}
						</button>
					</div>
					<div class="sm">
		...
		<div class="bottom">
			...
			<div v-if="state['stats']">
				<a @click.prevent :title="$t('pages.index.stats_online_tooltip')" style="color: var(--ui-success-color)">
					{{ state['stats']['online'] }}
				</a>
				/
				<a @click.prevent :title="$t('pages.index.stats_total_tooltip')" style="color: var(--ui-warning-color)">
					{{ state['stats']['users'] }}
				</a>
				&nbsp;&nbsp;&nbsp;&copy;
