<template>
	...
	<div class="page-support">
		<UiHeading :title="$t('pages.support.index.title')" :count="page.items.length" class="support-heading">
			<template #actions>
				<UiButton v-if="!request" @click="newRequest">
					<PlusIcon aria-hidden="true"/>
					{{ $t('pages.support.index.create_request') }}
				</UiButton>
			</template>
		</UiHeading>
		...
		<UiPanel clip>
			...
			<div v-else class="support-table-wrap">
				<UiTable class="support-table">
					<thead>
						<tr>
							<th scope="col">{{ $t('pages.support.index.col_id') }}</th>
							<th scope="col">{{ $t('pages.support.index.col_subject') }}</th>
							<th scope="col">{{ $t('pages.support.index.col_status') }}</th>
							<th scope="col">{{ $t('pages.support.index.col_date') }}</th>
						</tr>
					</thead>
					<tbody>
