<template>
	<div v-if="page" class="table-responsive">
		...
		<table ref="form" class="table">
			...
			<tr v-for="techId in page['tech']" align="center">
				<th>{{ $root.getLang('TECH', techId) }}</th>
			...
			<tr v-for="(name, fleetId) in $root.getLang('TECH')" v-if="fleetId > 200 && fleetId < 300" align="center">
				<th>{{ name }}</th>
			...
			<tr v-for="(name, fleetId) in $root.getLang('TECH')" v-if="fleetId > 400 && fleetId < 500" align="center">
				<th>{{ name }}</th>
