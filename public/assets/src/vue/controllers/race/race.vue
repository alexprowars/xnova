		...
		<div class="table raceSelect">
			...
			<div class="row">
				<div class="th col-6 text-left">
					<div style="text-align:center">
						...
						<img :src="$root.getUrl('assets/images/skin/race1.gif')">
					</div>
					<br>
					...
					<div v-if="race === 0" style="text-align:center">
						<router-link to="/race/index/sel/1/"><input type="button" value="Выбрать"></router-link>
					</div>
					<br>
				</div>
				<div class="th col-6 text-left">
					<div style="text-align:center">
						<div class="separator"></div>
						<img :src="$root.getUrl('assets/images/skin/race2.gif')">
					</div>
					<br>
					<font color="#adff2f">Особенности расы:</font>
					...
					<div v-if="race === 0" style="text-align:center">
						<router-link to="/race/index/sel/2/"><input type="button" value="Выбрать"></router-link>
					</div>
					<br>
				</div>
			</div>
			...
			<div class="row">
				<div class="th col-6 text-left">
					<div style="text-align:center">
						<div class="separator"></div>
						<img :src="$root.getUrl('assets/images/skin/race3.gif')">
					</div>
					<br>
					<font color="#adff2f">Особенности расы:</font>
					...
					<div v-if="race === 0" style="text-align:center">
						<router-link to="/race/index/sel/3/"><input type="button" value="Выбрать"></router-link>
					</div>
					<br>
				</div>
				<div class="th col-6 text-left">
					<div style="text-align:center">
						<div class="separator"></div>
						<img :src="$root.getUrl('assets/images/skin/race4.gif')">
					</div>
					<br>
					<font color="#adff2f">Особенности расы:</font>
					...
					<div v-if="race === 0" style="text-align:center">
						<router-link to="/race/index/sel/4/"><input type="button" value="Выбрать"></router-link>
					</div>
					<br>
				</div>
			</div>
