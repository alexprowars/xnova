<template>
	<div class="page-stat">
		...
		<stat-players v-if="form.list === 'players'" :items="items"></stat-players>
		<stat-alliances v-if="form.list === 'alliances'" :items="items"></stat-alliances>
		<stat-races v-if="form.list === 'races'" :items="items"></stat-races>
	</div>
</template>

<script>
	import StatPlayers from './stat-players.vue'
	import StatAlliances from './stat-alliances.vue'
