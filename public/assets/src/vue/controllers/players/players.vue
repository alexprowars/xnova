					...
					<div class="row border-0">
						...
						<div class="col-6">
							<div class="table">
								...
								<div class="row">
									...
									<div class="col-8 p-a-0">
										<router-link :to="'/galaxy/'+page['galaxy']+'/'+page['system']+'/'" style="font-weight:normal">
								...
								<div v-if="page['ally_id'] > 0" class="row">
									...
									<div class="col-8 p-a-0">
										<router-link :to="'/alliance/info/'+page['ally_id']+'/'">
											{{ page['ally_name'] }}
										</router-link>
									</div>
								</div>
							...
							<div v-if="page['race'] !== 0">
								<br><img :src="$root.getUrl('assets/images/skin/race'+page['race']+'.gif')" alt="">
							</div>
						</div>
						<div class="col-2">
							<img :src="$root.getUrl('assets/images/ranks/m'+page['m']+'.png')" alt="Промышленная отрасль" title="Промышленная отрасль">
							<br>
							<img :src="$root.getUrl('assets/images/ranks/f'+page['f']+'.png')" alt="Военная отрасль" title="Военная отрасль">
						</div>
					</div>
				</div>
			</div>
