<template>
	<div v-if="page" class="page-overview-rename">
		<div class="block">
				...
				<router-form :action="'/overview/rename/pl/'+page['planet_id']+'/'">
					<div class="table middle">
						<div class="row">
							...
							<div class="col th">
								<router-link to="/overview/delete/">
					...
					<div class="table">
						<div class="row">
							<div v-for="i in page['images'][page['type']]" class="col-6 col-sm-3 col-md-2">
								...
								<label :for="'image_'+i"><img :src="$root.getUrl('assets/images/planeten/'+page['type']+'planet'+(i < 10 ? '0' : '')+i+'.jpg')" align="absmiddle" width="100%"></label>
							</div>
						</div>
