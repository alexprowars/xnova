	...
	<div>
		<table class="table">
			...
			<tr v-for="diplo in page['DMyQuery']">
				...
				<th>
					<router-link :to="'/alliance/diplomacy/edit/del/id/'+diplo['id']+'/'"><img src="/images/abort.gif" alt="Удалить заявку"></router-link>
				</th>
			</tr>
		...
		<table class="table">
			...
			<tr v-for="diplo in page['DQuery']">
				...
				<th>{{ $t('alliance.diplomacy_status.'+diplo['type']) }}</th>
				<th>
					<router-link :to="'/alliance/diplomacy/edit/suc/id/'+diplo['id']+'/'"><img src="/images/appwiz.gif" alt="Подтвердить"></router-link>
					<router-link :to="'/alliance/diplomacy/edit/del/id/'+diplo['id']+'/'"><img src="/images/abort.gif" alt="Удалить заявку"></router-link>
				</th>
			</tr>
		...
		<router-form action="/alliance/diplomacy/edit/add/">
			<table class="table">
				...
				<tr>
					<td class="c"><router-link to="/alliance/">назад</router-link></td>
					<td class="c">
