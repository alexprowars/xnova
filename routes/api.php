...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('tech/{id}', [Controllers\TechController::class, 'info'])->name('tech');
	Route::match(['get', 'post'], 'start', [Controllers\StartController::class, 'index'])->name('start');
	...
	Route::get('players/stat/{id}', [Controllers\PlayersController::class, 'stat'])->name('players');
	...
	Route::get('chat', [Controllers\ChatController::class, 'index'])->name('chat');
	...
	Route::match(['get', 'post'], 'alliance/make', [Controllers\AllianceController::class, 'make'])->name('alliance.make');
	...
	Route::get('fleet/g{galaxy}/s{system}/p{planet}/t{type}/m{mission}', [Controllers\FleetController::class, 'index'])->name('fleet');
	...
	Route::get('log/new', [Controllers\LogController::class, 'new'])->name('log.new');
	Route::post('log/new', [Controllers\LogController::class, 'newSave'])->name('log.new.save');
	...
	Route::match(['get', 'post'], 'messages/write/{id}', [Controllers\MessagesController::class, 'write'])->name('messages');
	...
	Route::match(['get', 'post'], 'options', [Controllers\OptionsController::class, 'index'])->name('options');
