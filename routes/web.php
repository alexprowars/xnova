...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('chat', [Controllers\ChatController::class, 'index']);
	...
	Route::get('fleet', [Controllers\Fleet\FleetController::class, 'index'])->name('fleet');
	Route::get('fleet/list', [Controllers\Fleet\FleetController::class, 'list']);
	Route::get('fleet/checkout', [Controllers\Fleet\FleetCheckoutController::class, 'index'])->middleware(IsVacationMode::class);
	Route::post('fleet/checkout', [Controllers\Fleet\FleetCheckoutController::class, 'send'])->middleware(IsVacationMode::class);
