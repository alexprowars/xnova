...
return new class extends Migration {
	public function up()
	{
		Schema::create('users', function (Blueprint $table) {
			...
			$table->timestamp('officier_geologist')->nullable();
			$table->timestamp('officier_admiral')->nullable();
			$table->timestamp('officier_engineer')->nullable();
			$table->timestamp('officier_technocrat')->nullable();
			$table->timestamp('officier_architect')->nullable();
			$table->timestamp('officier_metaphysician')->nullable();
			$table->timestamp('officier_mercenary')->nullable();
